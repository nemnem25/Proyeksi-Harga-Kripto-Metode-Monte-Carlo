...
try:
    ...
    for days in [7, 30, 90]:
        ...
        # Perhitungan kesimpulan berdasarkan rentang harga
        harga_kumulatif_tertinggi = format_angka_indonesia(rentang_atas)
        st.write(f"**Kesimpulan Proyeksi: Rentang Harga Tertinggi (Kumulatif): {harga_kumulatif_tertinggi}**")
    
except Exception as e:
    st.error(f"Gagal melakukan simulasi atau mengambil data: {str(e)}")
